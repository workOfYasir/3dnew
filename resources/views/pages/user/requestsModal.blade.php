                                        ...
                                        <li class="nav-item" role="presentation">
                                            ...
                                            <button class="nav-link" id="designer-tab tab tab3" data-bs-toggle="tab"
                                                ...
                                                aria-controls="designer" aria-selected="false"><span
                                                    class="notification">2</span>مجتمع المصممين</button>
                                            @else
                                        ...
                                        <div class="tab-pane fade" id="public-services" role="tabpanel"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <a href="{{ route('perposalAction',@$order->PerposalPDF->id) }}">
                                                    more
                                                    </a>
                                                @endif
                                                    ...
                                                    <div class="dropdown  pt-4">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('purposal.pdf',@$order->PerposalPDF->id) }}">
                                                                    New Purposal
                                                                </a>
                                                            </li>
                                                            @else
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="request-box" data-bs-toggle="modal"
                                                            ...
                                                            <div class="data">
                                                                ...
                                                                <span> غير معروف</span>
                                                                <p>المنتج المطلوب:</p>
                                                                <span> عنوان التصميم يكتب هنا ويستوعب سطرين كحد اقصى
                                                                    ..</span>
                                                            </div>
                                                        </div>
                                                    </div>
