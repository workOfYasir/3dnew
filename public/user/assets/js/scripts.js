$(function() {
    ...
    function desLoginValidateEmail(email) {
        var emailReg = /^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/;
        if (!emailReg.test(email) || $('#designerloginModal .email').val().length == 0) {
            $('#designerloginModal .email-error').removeClass('d-none');
            ...
            $('#designerloginModal .email-error').addClass('d-none');
